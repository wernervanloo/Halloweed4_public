...
* = bitmap1 "[DATA] bitmap data"
  .import c64 "includes/huis1.kla",0,$1f40
...
* = screen1 "[DATA] screen colors"
  .import c64 "includes/huis1.kla",$1f40,$3e8
  .fill 24, $00
...
* = screen2 "[RUNTIME] screen 2 colors" virtual
  .fill 1024, 0
* = screen3 "[RUNTIME] screen 3 colors" virtual
  .fill 1024, 0

* = d800Colors "[DATA] d800 colors"
  .import c64 "includes/huis1.kla",$1f40+$3e8,$3e8
  .fill 24,0
  .import c64 "includes/huis1.kla",$1f40+$3e8,$100